...
public class FuelCookingReg {
    ...
    public static final RegistryObject<RecipeSerializer<?>> FUEL_SMELTING_SERIALIZER =
            RECIPE_SERIALIZERS.register("fuel_smelting", () -> new FuelCookingRecipeSerializer(RecipeType.SMELTING));
    public static final RegistryObject<RecipeSerializer<?>> FUEL_BLASTING_SERIALIZER =
            RECIPE_SERIALIZERS.register("fuel_blasting", () -> new FuelCookingRecipeSerializer(RecipeType.BLASTING));
    public static final RegistryObject<RecipeSerializer<?>> FUEL_SMOKING_SERIALIZER =
            RECIPE_SERIALIZERS.register("fuel_smoking", () -> new FuelCookingRecipeSerializer(RecipeType.SMOKING));
